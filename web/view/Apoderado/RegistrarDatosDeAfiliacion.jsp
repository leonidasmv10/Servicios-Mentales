...
<body>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input required type="text" name="nombreT" class=" form-control" placeholder="Ingrese su nombre"
                                >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            ...
                            <input required type="text" name="apellidosT"  class=" form-control" placeholder="Ingrese su nombre"
                                >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>DNI: </label>
                            <input required type="number" name="dniT" class=" form-control" placeholder="Ingrese su nombre" >
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group">
                            <label>Sexo: </label>
                            <select required name="sexoT" id="" class="form-control">
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <input required type="date" name="fechaNacT" class=" form-control" >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>Dirección: </label>
                            <input required type="text" name="direccionT" class=" form-control" >
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group">
                            <label>Celular: </label>
                            <input required type="tel" name="celularT" class=" form-control" >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>Celular de emergencia: </label>
                            <input required type="tel" name="celEmergenciaT" class=" form-control" >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>E-Mail de contacto: </label>
                            <input required type="text" name="correoT" class=" form-control" >
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input required type="text" name="religionT" class=" form-control" >
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>Estado civil: </label>
                            <select required name="estadoCivilT"  class="form-control">
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <select required name="nivelAcademicoT" id="" class="form-control">
    ...
    <br>
    <center>
        <button type="submit" name="botonRegistrar" style="background-color: rgb(70, 206, 17); color:black" class="btn btn-success"><strong>Registrar</strong></button>
        &nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
        <a class="btn btn-danger" href="../../view/Apoderado/Home.jsp"><strong>Cancelar</strong></a>
    </form>
    </center>
    <br>
    <br>
