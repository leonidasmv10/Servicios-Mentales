                ...
                <div class="row">             
                    ...
                    <div class="col-sm-6 login-section-wrapper" style="align-items: center; align-content: center; text-align: center;">          
                        <div class="login-wrapper">
                            <img src="../assets/imgs/login_paciente.png" width="50%"> 
                            <br>
                            <br>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input  required type="text" id="usuario" class="form-control" placeholder="Ingrese su usuario">
                                </div>              
                            ...
                            <a href="Registrar.jsp" class="btn">Registrarme</a>                          
                        </div>
                    </div>
                </div>
            </div>
