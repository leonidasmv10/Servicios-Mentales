<html lang="en">
    ...
    <br>
<center>
    <a class="btn btn-warning" href="http://localhost:8080/Servicios_Mentales/view/Apoderado/ModificarDatosDeAfiliacion.jsp"><strong>Actualizar Información</strong></a>
</center>
<br>
<br>
