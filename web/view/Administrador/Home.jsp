    ...
    <body>
            ...
            <div class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <div class="input-group">
                    <div class="input-group-append">
                        <a id="idLogout" onclick="" style="color: white;" class="nav-link" href="Login.jsp">
        ...
        <div class="body row">
            ...
            <div class="col-sm-10">
                ...
                <br>
                <center>
                    <a href="" class="btn btn-warning"><strong>Agregar Anuncios</strong></a>
                </center>
                <br><br>
                <div style="text-align: center; align-items: center;">
                    <br>
                ...
                <br>                        
                <center>
                    <a href="" class="btn btn-warning"><strong>Agregar Novedades</strong></a>
                </center>
                <br>
                <br>
            </div>
