            ...
            <div class="col-sm-2" style="background-color: rgb(19, 94, 124);">
                ...
                <div class="col-sm-10">
                    ...
                    <div style="text-align: center; align-items: center;">
                        <br>
                        <br>
                        <img src="../imgs/frm_trabajador.png" alt="Trabajador" width="13%">
                        <br>
                        <br>
                        <h3 style="color:rgb(29, 140, 184);"><strong>REGISTRAR TRABAJADOR</strong></h3>
                    </div>
                        <br>
                        <br>
                        <form>
                            ...
                            <div class="row">                                
                                <div class="col-sm-4">
                                    Celular personal:
                                    <input id="celularPersonal" class="form-control" type="tel" placeholder="Ingrese su número de celular" >
                                </div>
                                <div class="col-sm-5">
                                    E-Mail:
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    Contraseña:
                                    <input id="password" class="form-control" type="tel" placeholder="Ingrese su contraseña" >
                                </div>
                                <div class="col-sm-4">
                                    Estado de cuenta:
                        ...
                        <center>                            
                            ...
                            &nbsp;
                            &nbsp;
                            <a class="btn btn-danger" href="TrabajadoresIndex.html"><strong>Cancelar</strong></a>
                        </center>   
                        </form>
                        <br>
                        <br>                                                
