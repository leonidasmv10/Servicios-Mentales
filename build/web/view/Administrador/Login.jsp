...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">        
                    ...
                    <div class="col-sm-6 login-section-wrapper" style="align-items: center; align-content: center; text-align: center;">          
                        <div class="login-wrapper">
                            <img src="../assets/imgs/login_admin.jpg" width="50%"> 
                            <br>
                            <br>
                            <h1 class="login-title">Iniciar sesión</h1>
                            <form>
                                <div class="form-group">
                                    <label for="email" id="prueba">Usuario</label>
                                ...
                                <br>
                                <input id="btnIngresar" type="submit" style="padding: 10px 17px; background-color: rgb(29, 140, 184); border-raius: 0; font-size: 15px; font-weight: bold; color: #fff; margin-bottom: 14px;" value="Ingresar">
                            </form>   
        ...
        <script src="../assets/scripts/Administrador.js" type="text/javascript"></script>
