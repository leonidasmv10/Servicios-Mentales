                ...
                <div class="col-sm-10">
                    ...
                    <!--Contenido-->
                        <div style="text-align: center; align-items: center;">
                            <br>
                            <br>
                            <img src="../imgs/frm_profesionales.png" alt="Profesional" width="13%">
                            <br>
                            <br>
                            <h3 style="color:rgb(29, 140, 184);"><strong>PROFESIONALES</strong></h3>
                        </div>
                        <br>
                        <div class="container" style="align-items: center; align-content: center;">
                            <div style="text-align: left; align-items: center;">
                                ...
                                &nbsp;
                                &nbsp;
                                <a class="btn btn-warning" href="http://localhost:8080/Servicios_Mentales/view/Administrador/RegistrarProfesional.jsp"><strong>+ Agregar Profesional</strong></a>
                            </div>                            
                        </div>
                        <br>
                        <table class="table table-active" style="align-items: center; align-content: center; text-align: center; padding: 5px;" id="mytable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>+51987456123</td>
                                    <td>    
                                        <a href="VerProfesionales.html" class="btn btn-primary"><strong>Datos de Filiación</strong></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
